...
`Closed` line on the plan records the closeout date and evidence.
...
| [2026-08-09-pi-collector-followups](2026-08-09-pi-collector-followups.md) | Done | 2026-08-09 | Payload-truncation hardening (two-tier caps + observable exporter) and raw `before_provider_request` payload capture (`pi.llm.request.payload`) |
...
| [2026-08-10-kyber-observe-cli](2026-08-10-kyber-observe-cli.md) | Done | 2026-08-10 | `kyber-observe` CLI installer for plugins, status bars, and hooks |
